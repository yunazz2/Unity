...
public class GameManager : MonoBehaviour
{
    ...
    // 게임의 종료 여부를 저장할 프로퍼티
    // private으로 선언한 isGameOver 변수는 다른 클래스에서 읽고 쓸 수 없다.
    // 대신 IsGameOver라는 프로퍼티를 선언해 isGameOver 변수를 간접적으로 다른 클래스에 노출한다.
    ...
    void Start()
    {
        ...
        // SpawnPointGroup을 검색을 통해 추출하고, 해당 게임 오브젝트 하위에 있는 모든 point를 추출
        // SpawnPointGroup 게임 오브젝트의 Transform 컴포넌트 추출
        Transform spawnPointGroup = GameObject.Find("SpawnPointGroup")?.transform;

        // SpawnPointGroup 하위에 있는 모든 차일드 게임 오브젝트의 Transform 컴포넌트 추출
